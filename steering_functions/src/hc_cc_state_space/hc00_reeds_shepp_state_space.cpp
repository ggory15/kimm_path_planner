...
HC_CC_RS_Path *HC00_Reeds_Shepp_State_Space::hc00_reeds_shepp(const CCState &state1, const CCState &state2) const
{
...
double HC00_Reeds_Shepp_State_Space::get_distance(const CCState &state1, const CCState &state2) const
{
...
vector<Control> HC00_Reeds_Shepp_State_Space::get_controls(const CCState &state1, const CCState &state2) const
{
