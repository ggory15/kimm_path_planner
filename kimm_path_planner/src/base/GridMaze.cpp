...
#include "kimm_path_planner/third_party/stb/stb_image.h"
#include "kimm_path_planner/third_party/stb/stb_image_resize.h"
...
shared_ptr<GridMaze> GridMaze::createSimple(double width, double height) {
  auto environment = std::make_shared<GridMaze>(1, width, height);
  //environment->fill(Rectangle(18, 18, 34, 34), true);
  //environment->setStart(Point(25, 25));
  //environment->setGoal(Point(21, 45)); //y, x
  ///
